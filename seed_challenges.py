...
challenges = [
    # EASY (1-5) - 100 Pts
    {
        ...
        "flag": "ARISE{84}", "hint": "The Euclidean algorithm is based on the principle that the greatest common divisor of two numbers does not change if the larger number is replaced by its difference with the smaller number.", "hint_cost": 10
    },
    {
        ...
        "flag": "ARISE{3}", "hint": "Divide the entire equation by the greatest common divisor of the coefficient and modulus.", "hint_cost": 10
    },
    {
        ...
        "flag": "ARISE{1}", "hint": "Fermat's Little Theorem states that if p is a prime number, then for any integer a, a^p ≡ a (mod p).", "hint_cost": 10
    },
    {
        ...
        "flag": "ARISE{this_is_a_secret}", "hint": "Try shifting the letters back by 3.", "hint_cost": 10
    },
    {
        ...
        "flag": "ARISE{this_is_a_sample_message}", "hint": "Analyze letter frequency or try a simple shift related to the previous letter.", "hint_cost": 10
    },
    ...
    # MEDIUM (6-10) - 250 Pts
    {
        ...
        "flag": "ARISE{2753}", "hint": "The extended Euclidean algorithm finds integers x and y such that ax + by = gcd(a, b).", "hint_cost": 25
    },
    {
        ...
        "flag": "ARISE{157}", "hint": "Use the Chinese Remainder Theorem.", "hint_cost": 25
    },
    {
    ...
    },
    {
        ...
        "flag": "ARISE{attackatdawn}", "hint": "Key length is 5. Try common 5-letter words.", "hint_cost": 25
    },
    {
        ...
        "flag": "ARISE{instruments}", "hint": "Construct the 5x5 Playfair matrix with MONARCHY first.", "hint_cost": 25
    },
    ...
    # HARD (11-15) - 500 Pts
    {
        ...
        "flag": "ARISE{2}", "hint": "Check orders of elements starting from 2.", "hint_cost": 50
    },
    {
        ...
        "flag": "ARISE{composite}", "hint": "561 is a Carmichael number.", "hint_cost": 50
    },
    {
        ...
        "flag": "ARISE{act}", "hint": "Find the inverse of the matrix modulo 26.", "hint_cost": 50
    },
    {
        ...
        "flag": "ARISE{key_reuse_leaks_plaintext}", "hint": "XORing two ciphertexts encrypted with the same OTP key reveals the XOR of the plaintexts.", "hint_cost": 50
    },
    {
        ...
        "flag": "ARISE{carmichael_number}", "hint": "It behaves like a prime regarding Fermat's Little Theorem.", "hint_cost": 50
    },
    ...
    # EXTREME (16-17) - 1000 Pts
    {
        ...
        "flag": "ARISE{does_not_exist}", "hint": "Check the GCD of 84 and 180.", "hint_cost": 100
    },
    {
